...
if (Meteor.isClient) {
  describe('Editor', function(){
    ...
    it('should render not found message', function(){
      const wrapper = mount(<Editor note={undefined} selectedNoteId={'abc123'} call={call} browserHistory={browserHistory}/>);
      expect(wrapper.find('p').text()).toBe('Note not found')
    });

    it('should render pick note message', function(){
      const wrapper = mount(<Editor note={undefined} selectedNoteId={undefined} call={call} browserHistory={browserHistory}/>);
